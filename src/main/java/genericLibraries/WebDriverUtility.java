...
public class WebDriverUtility {/**
	 ...
	 */
		...
		/**
		 * This method is used to launch broswer
		 * @param browser
		 * @return 
		 */
		...
		/**
		 * This method waits untill element is found
		 * @param time
		 * 
		 */
 ...
 * @param jUtil 
 */
	public void takeScrenshot(JavaUtility jUtil) {
	...
	/**
	 * this method is used to switch to child browse 
	 */
